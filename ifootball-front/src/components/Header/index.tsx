        ...
        <header className={styles.header}>
            ...
            <div className={`${styles.backgroundMenu} ${!openSideBar && styles.backgroundMenuClose}`}>
                            ...
                            <div>
                                {openMenuBar.male &&
                                    <div className={styles.menu_in_menu_ops}>
                                        ...
                                        <Link className={styles.ops} href={'/ranking/goals/male'}>Gols</Link>
                                        <Link className={styles.ops} href={'/ranking/assists/male'}>Assistência</Link>
                                        <Link className={styles.ops} href={'/ranking/saves/male'}>Defesas</Link>
                                    </div>
                                }
                            </div>
                        </div>
                ...
                <div className={styles.outDiv}>
                    <Link href={'/edit-account'}><Image src={out} alt='Edit account' /> </Link>
                </div>

                <div className={styles.outDiv}>
                    <Link className={styles.outA} href="/" onClick={() => deleteCookie('user_token')}><Image className={styles.outImg} src={logOut} alt="outLogo" width={32} height={32} /><h4 className={styles.outH4}>SAIR</h4></Link>
                </div>
            </div>
